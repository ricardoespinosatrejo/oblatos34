...
class UserManager extends ChangeNotifier {
  ...
  int get rachaPoints => _rachaPoints;
  ...
  void setCurrentUser(Map<String, dynamic> user) {
    ...
    _rachaPoints = user['racha_points'] ?? 0;
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (data is Map && data['success'] == true) {
          ...
          final rachaPoints = payload['racha_points'] ?? 0;
          ...
          final parsedRachaPoints = (rachaPoints is int) ? rachaPoints : int.tryParse(rachaPoints.toString()) ?? 0;
          ...
          _rachaPoints = parsedRachaPoints;
  ...
  /// Completar reto diario (método placeholder para compatibilidad)
  void completarRetoDiario() {
    // Este método puede ser usado para marcar que se completó un reto diario
    // Por ahora solo notifica a los listeners
    notifyListeners();
  }
}
